...
#   # end
#
#   def find_kv([], [], _key), do: nil
#   def find_kv([k | _ks], [_v | _vs], key) when key < k, do: nil
#   def find_kv([k | ks], [_v | vs], key) when key > k, do: find_kv(ks, vs, key)
#   def find_kv([k | _ks], [v | _vs], key) when k == key, do: v
