...
#   # alias Monsoon.BTree.Util
#   # alias Monsoon.Log
#
#   # @spec add(node :: BTree.t(), key :: term(), value :: term(), extra :: map()) ::
#   #         {:normal, node :: BTree.t(), map()}
#   #         | {:split, {left :: BTree.t(), split_key :: term(), right :: BTree.t()}, extra :: map()}
...
#   #   {:ok, child} = Log.get_node(extra.log, child_bp)
#   #
...
#   # end
#
#   def split_interior(node, idx, sep_key, lnode_bp, rnode_bp) do
...
#   # end
#
#   def split_leaf(node, idx, key, value) do
#     # full, split node
...
#   #   %{btree: {root_bp, leaf_links_bp, metadata_bp}} = extra
#   #   {:ok, leaf_links} = Log.get_leaf_links(extra.log, leaf_links_bp)
#   #
...
#   #
#   #   %{extra | btree: {root_bp, leaf_links_bp, metadata_bp}}
#   # end
#
