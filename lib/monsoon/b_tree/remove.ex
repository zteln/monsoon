...
#   # end
#
#   def merge_interior(idx, lchild, parent, rchild) do
...
#   end
#
#   def rotate_interior(idx, lchild, parent, rchild, from_left?) do
#     if from_left? do
...
#   end
#
#   def merge_leafs(idx, lchild, parent, rchild) do
...
#   end
#
#   def rotate_leafs(idx, lchild, parent, rchild, from_left?) do
#     if from_left? do
